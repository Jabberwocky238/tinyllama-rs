...
def to_py_obj(obj):
    ...
    # }
    framework_to_py_obj = lambda obj: obj.detach().cpu().tolist()
    ...
    return framework_to_py_obj(obj)
        ...
        **kwargs,
        ...
        for file_id, file_path in vocab_files.items():
            ...
            if is_local:
                ...
                print(f"loading file {file_path} from cache at {resolved_vocab_files[file_id]}")
